...
class BaseModel(BaseModule, metaclass=ABCMeta):
    ...
    def forward(self, img, ref_expr_inds, img_metas, train_flag=True, return_loss=True, **kwargs):
        ...
        if return_loss:
            return self.forward_train(img, ref_expr_inds, img_metas, train_flag=train_flag, **kwargs)
        else:
